    ...
    <header className="flex items-center justify-between px-6 py-3 border-b border-aira-border bg-aira-darker relative overflow-hidden">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold text-aira-blue glow-text tracking-widest font-mono">
              AIRA
            </h1>
            <span className="text-xs text-aira-text-dim font-mono border border-aira-border px-2 py-0.5 rounded">
              v1.0
            </span>
          </div>
          <p className="text-xs text-aira-text-dim font-mono tracking-wider">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-mono text-aira-text-dim">
